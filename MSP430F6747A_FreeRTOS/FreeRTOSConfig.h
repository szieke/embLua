...
extern void sendBlocking(const char* buffer);

#define configTICK_VECTOR				TIMER0_A0_VECTOR
#define configASSERT( x ) if( ( x ) == 0 ) {sendBlocking("\n\nconfigASSERT\n"); sendBlocking(__FILE__);}
...
#else
#define configTOTAL_HEAP_SIZE     ( ( size_t ) (2000 + LUA_HEAP_SIZE) )
#endif
